...
export class Movable extends Collidable {
  constructor({ canvas, type = 'rect', attrs = {}, isContainer = false, coordsInput$ }) {

    super({ canvas, type, attrs })
...
console.warn('Movable', this);
  ...
  set position({ x, y }) {
    this.transform = super.selfTransforms.getItem(0);
