...
export class Game {
  constructor(selector, { key1 = 'vfuck1', key2 = 'vfuck2' }) {
    ...
    this.board = new Board(this.self, { id: 'boardBackground', classList: ['board', 'active'], data: { some: 'data' }, x: 0, y: 0, width: window.innerWidth, height: 350, fill: "url(#boardGradient)" })
    ...
    if (this.selfTransforms.length === 0) {
      this.selfTranslate = this.self.createSVGTransform();
