...
export class Paddle extends Collidable {
  constructor(canvas, boardGroup, id, attrs = { height: 100, boardHeight: 400, boardHeight: 384 }, input$ = null) {
    super({canvas, type: 'rect', attrs:{ ...attrs, y: attrs.y - 50, id: id, classList: ['paddle'], fill: '#18181899' }, isContainer:false});
